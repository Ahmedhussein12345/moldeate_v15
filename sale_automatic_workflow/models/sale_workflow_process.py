...
class SaleWorkflowProcess(models.Model):
    ...
    # module customization for moldeate project by Manish Bohra
    woo_automation = fields.Boolean(string="Woocommerce Automation", help='This checkbox use for Woocommerce Automation')