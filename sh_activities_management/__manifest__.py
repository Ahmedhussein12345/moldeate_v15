...
# Part of Softhealer Technologies.
{
    ...
    "license": "OPL-1",
    'version': '15.0.12',
    "summary": "Activity Management Activity Scheduler Manage Employee Activity Manage Supervisor Activity filter Activity Manage Multi Activities Schedule Mass Activities Dynamic Action For Multiple Activities Manage Odoo",
    ...
    'assets': {
        'web.assets_backend': [
            ...
            'sh_activities_management/static/src/js/systray.js',
            'sh_activities_management/static/src/js/activity_dashboard.js',
            ],
        'web.assets_qweb': [
            'sh_activities_management/static/src/xml/**/*',
