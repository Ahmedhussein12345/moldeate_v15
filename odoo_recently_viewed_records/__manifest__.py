...
Tracking Recently Accessed Activities""",
  ...
  "assets": {
      'web.assets_backend': [
          'odoo_recently_viewed_records/static/src/js/recently_record.js',
          'odoo_recently_viewed_records/static/src/js/widget.js',
          'https://cdnjs.cloudflare.com/ajax/libs/URI.js/1.18.2/URI.min.js',
      ],
      'web.assets_qweb': [
          'odoo_recently_viewed_records/static/src/xml/recently_record_widget.xml',
      ],
  },
