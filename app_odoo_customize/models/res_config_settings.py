...
class ResConfigSettings(models.TransientModel):
    ...
    app_show_about = fields.Boolean('Show About', help="Show About section in General Settings")
    app_show_contacts_settings = fields.Boolean('Show Contacts Settings', help="Show Contact settings section in General Settings")
    app_show_integration = fields.Boolean('Show Integrations', help="Show Integration section in General Settings")
    app_show_statistics = fields.Boolean('Show Statistics', help="Show Statistics section in General Settings")

    app_show_shortcuts = fields.Boolean('Show Shortcut', help="When enable,User can see shortcut menu")
    app_show_developer_tool = fields.Boolean('Show Developer Tools', help="Show Developer Tools section in General Settings")
    ...
    def get_values(self):
        ...
        app_show_about = True if ir_config.get_param('app_show_about') == "True" else False
        app_show_contacts_settings = True if ir_config.get_param('app_show_contacts_settings') == "True" else False
        app_show_integration = True if ir_config.get_param('app_show_integration') == "True" else False
        app_show_statistics = True if ir_config.get_param('app_show_statistics') == "True" else False
        app_show_shortcuts = True if ir_config.get_param('app_show_shortcuts') == "True" else False
        app_show_developer_tool = True if ir_config.get_param('app_show_developer_tool') == "True" else False
        ...
        res.update(
            ...
            app_show_about=app_show_about,
            app_show_contacts_settings=app_show_contacts_settings,
            app_show_integration=app_show_integration,
            app_show_statistics=app_show_statistics,
            app_show_shortcuts=app_show_shortcuts,
            app_show_developer_tool=app_show_developer_tool,
    ...
    def set_values(self):
        ...
        ir_config.set_param("app_show_about", self.app_show_about or "False")
        ir_config.set_param("app_show_contacts_settings", self.app_show_contacts_settings or "False")
        ir_config.set_param("app_show_integration", self.app_show_integration or "False")
        ir_config.set_param("app_show_statistics", self.app_show_statistics or "False")
        ir_config.set_param("app_show_shortcuts", self.app_show_shortcuts or "False")
        ir_config.set_param("app_show_developer_tool", self.app_show_developer_tool or "False")
        ir_config.set_param("app_show_account", self.app_show_account or "False")
        ir_config.set_param("odoobot_state", self.odoobot_state or "False")
    ...
    @api.constrains('odoobot_state')
    def change_odoobot_status_for_all(self):
        for rec in self.env['res.users'].search([]):
            rec.odoobot_state = self.odoobot_state