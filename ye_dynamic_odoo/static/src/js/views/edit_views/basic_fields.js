odoo.define('ye_dynamic_odoo.FieldBasic', function (require) {
    ...
    var Condition = WidgetBase.extend({
        ...
        _renderCodeEdit: function () {
            ...
            this.inputEdit = new Input(this, {
                ...this.props,
                label: "# Code editor  (enter to save)",
                value: value || "[]"
            });
    ...
    var CBCondition = WidgetBase.extend({
        ...
        renderView: function () {
            const {value} = this.state;
            this.ref.condition = new Condition(this, {
                ...this.props, onChange: this.onChangeValue.bind(this),
                value: Array.isArray(value) ? JSON.stringify(value) : "[]"
            });
            this.ref.checkbox = new Checkbox(this, {
                ...this.props,
                value: value,
    ...
    var ColorLine = Widget.extend({
        ...
        init: function (parent, params) {
            ...
            this.state = {value: value || {}};
            this.viewInfo = {
                danger: {}, warning: {}, success: {}, primary: {}, info: {}, muted: {}, bf:
    ...
    var SelectFieldModel = Widget.extend({
        ...
        prepareFields: function () {
            ...
            if (dataRoot) {
                Object.keys(dataRoot).map((fName) => {
                    var field = {name: fName, string: fName}, fieldType = dataRoot[fName], strField = fieldType,
        ...
        renderFieldSelector: async function () {
            ...
            let fsOptions = Object.assign(options || {}, {
                readonly: false, editReport: true,
        ...
        renderWidget: function () {
            ...
            const {fieldNode} = data, {widget} = fieldNode.widgetOptions,
                propsSelect = {
                    data: selectData,
                    label: "Widget",
                    value: widget || data.widget || false,
                    onChange: this.onChangeWidget.bind(this)
                };
    ...
    var ParentElNode = Widget.extend({
        ...
        getElParent: function (elNode, listEl) {
            if (elNode) {
                let tagName = elNode[0].tagName.toLowerCase(),
                    itemProps = {tagName: tagName, path: this.getPath(elNode)};
                if (tagName == "div") {
        ...
        renderPropsElActive: function () {
            ...
            let nodeProperty = new ReportProperty(this, Object.assign(this.props, {data: elProps})),
                path = this.getPath(activeEl);
    ...
    var ReportProperty = Widget.extend({
        ...
        onKeyUp: function (e) {
            const {onChange} = this.props, el = $(e.currentTarget), type = el.attr("data"), value = el.val(),
        ...
        renderSelectField: async function () {
            ...
            if (fieldNode) {
                ...
                var fieldSelector = new SelectFieldModel(this, {
                    onChange: (data) => onChange({
                        name: "field",
                        value: data
                    }), chain: chain, dataRoot: dataRoot, modelName: null
                });
        ...
        onClickShow: function (e) {
            ...
            this['_rpc']({
                ...
                let options = {
                    ...
                    context: {}, title: "Change Field Property", view_id: false,
    ...
    return {
        ...
        Many2one: Many2one,
        Selection: Selection,
        Many2manyTagCheckbox: Many2manyTagCheckbox,
        Radio: Radio,
        Checkbox: Checkbox,
